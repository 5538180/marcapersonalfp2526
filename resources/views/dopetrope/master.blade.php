        ...
        <section id="header">
            ...
            <h1>
                <a href="{{ url(config('app.url'))}}">
                    <img src="{{ asset('dopetrope/images/mp-logo.png') }}" alt="Logo Marca Personal FP" width="200px" />
                </a>
            </h1>
                ...
                <div class="row">
                    ...
                    <div class="col-4 col-12-medium">
                        <section>
                            ...
                            <a href="#" class="image featured"><img src="{{ asset('/dopetrope/images/pic010.jpg') }}"
                                    alt="" /></a>
                            <p>
